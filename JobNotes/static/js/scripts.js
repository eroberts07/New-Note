...
$(document).ready(function(){
    ...
    var fieldHTML = '<div><input type="text" name="field_name[]" value=""/> <input type="number" id="quantity" name="quantity" min="1" max="10"><a href="javascript:void(0);" class="remove_button">Remove Field</a></div>'; //New input field html 
